--exec mySchema.SP_CREATE_FACT_SUMMARY

ALTER PROCEDURE mySchema.SP_CREATE_FACT_SUMMARY as 

delete  from mySchema.fact_summary;
...
where YEAR(o.OrderDate) = (SELECT top 1 anio from mySchema.settings)
GROUP BY
        s.SupplierID,
        MONTH(o.OrderDate),
        YEAR(o.OrderDate) 
...
SELECT 1 as successed, 'Su tabla fact_summary fue actualizada' as MSG
